    ...
    handler: () => {
      window.location.href = "/";
          ...
          section: "Books",handler: () => {
            ...
            },},{id: "news-恭喜杨智-卓妙华-贺紫盈-曾振涛四位同学在2025第一届全国大学生人工智能安全竞赛对抗赛中获全国一等奖",
          title: '恭喜杨智、卓妙华、贺紫盈、曾振涛四位同学在2025第一届全国大学生人工智能安全竞赛对抗赛中获全国一等奖。🎉🎉🎉',
          description: "",
          section: "News",},{id: "news-恭喜课题组成员张梦霞的研究论文-bdpackets-a-clean-label-backdoor-attack-on-network-traffic-classifiers-via-feature-fusion-成功被ccf-a类顶会ieee-infocom-2026录用-该成果为网络流量分类模型安全防护提供了新视角",
          title: '恭喜课题组成员张梦霞的研究论文《BDpackets: A Clean-label Backdoor Attack on Network Traffic Classifiers via Feature Fusion》成功被CCF A类顶会IEEE...',
          description: "",
          section: "News",},{id: "news-恭喜课题组成员胥迤潇的论文-at-field-rethinking-the-games-in-adversarial-training-被ccf-a类顶会aaai-2026录用-并受邀作口头报告-录用率仅17-6-口头报告率约2-5-该成果为对抗训练领域研究作出了积极贡献",
          title: '恭喜课题组成员胥迤潇的论文《AT-Field: Rethinking the Games in Adversarial Training》被CCF A类顶会AAAI 2026录用，并受邀作口头报告（录用率仅17.6%，口头报告率约2.5%），该成果为对抗训练领域研究作出了积极贡献。🎉🎉🎉',
          description: "",
